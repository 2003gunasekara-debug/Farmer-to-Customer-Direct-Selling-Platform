...
import MapAddressModal from '../components/MapAddressModal.jsx';
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg border border-[#c7dccd] bg-white px-2.5 py-1 text-xs font-semibold text-[#315744] hover:bg-[#f4faf6] transition"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 text-[#1f7a4d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              <textarea
                className="auth-input"
                rows={3}
                placeholder="Enter your delivery address or pick from the map"
                value={address}
